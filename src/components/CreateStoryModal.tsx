...
export function CreateStoryModal({ isOpen, onClose }: CreateStoryModalProps) {
  ...
  const handleCreate = () => {
    console.log("Story created:", { text, bgColor });
    setText("");
    onClose();
  };
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col">
        ...
        <div className="p-4">
          <div
            className="relative w-full aspect-[9/16] rounded-2xl overflow-hidden shadow-lg"
        ...
        <div className="p-4 border-t border-gray-200 space-y-4">
          ...
          {/* Actions */}
          <div className="flex gap-2">
            <button className="flex-1 py-3 px-4 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition-colors font-medium flex items-center justify-center gap-2">
